      ...
      <div className="container">
        <div className="row mt-5">
          <div className="col mt-3">
            <img src="media/logo.svg" alt="" style={{ width: "70%" }} />
          ...
          <div className="col mt-3">
            <p style={{ fontSize: "22px" }}>Account</p>
          ...
          <div className="col mt-3">
            <p style={{ fontSize: "22px" }}>Quick links</p>
            <a href="" style={{ textDecoration: "none", color: "#666666" }}>
              Upcoming IPOs
            </a>
            <br />
          ...
          <div className="footer-para mt-5 text-muted" style={{ fontSize: "15px" }}>
            <p>
          ...
          <div className="bottom-link">
            <a href="" style={{color:"#9B9B9B", margin:"12px"}}></a>NSE
            <a href="" style={{color:"#9B9B9B"}}></a>BSE 
            <a href="" style={{color:"#9B9B9B"}}></a>MCX 
            <a href="" style={{color:"#9B9B9B"}}></a>Terms & conditions 
            <a href="" style={{color:"#9B9B9B"}}></a>Policies & procedures 
            <a href="" style={{color:"#9B9B9B"}}></a>Privacy policy 
            <a href="" style={{color:"#9B9B9B"}}></a>Disclosure 
            <a href="" style={{color:"#9B9B9B"}}></a>For investor's attention 
            <a href="" style={{color:"#9B9B9B"}}></a>Investor charter
          </div>
        </div>
      </div>
    </div>
